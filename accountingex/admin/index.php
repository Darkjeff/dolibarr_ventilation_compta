 ...
 *
 */
$list=array('ACCOUNTINGEX_SEPARATORCSV','ACCOUNTINGEX_LENGTH_GACCOUNT','ACCOUNTINGEX_LENGTH_AACCOUNT','COMPTA_ACCOUNT_CUSTOMER','COMPTA_PRODUCT_BUY_ACCOUNT','COMPTA_PRODUCT_SOLD_ACCOUNT','COMPTA_SERVICE_BUY_ACCOUNT','COMPTA_SERVICE_SOLD_ACCOUNT','COMPTA_ACCOUNT_SUPPLIER','ACCOUNTINGEX_ACCOUNT_SUSPENSE','ACCOUNTINGEX_ACCOUNT_TRANSFER_CASH','ACCOUNTINGEX_SELL_JOURNAL','ACCOUNTINGEX_PURCHASE_JOURNAL','ACCOUNTINGEX_BANK_JOURNAL','ACCOUNTINGEX_SOCIAL_JOURNAL','ACCOUNTINGEX_CASH_JOURNAL','ACCOUNTINGEX_MISCELLANEOUS_JOURNAL'
);
