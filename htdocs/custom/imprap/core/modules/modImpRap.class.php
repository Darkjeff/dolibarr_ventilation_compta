...
/**
 * Description and activation class for module ImpRap
 */
class modImpRap extends DolibarrModules
{
...
//        )
	...
	public $name = "import rapprochement";

	/** @var string Module short description */
	public $description = "Description of module ImpRap";

	/** @var string Module long description */
	public $descriptionlong = "import des ecritures depuis fichier csv pour le rapprochement";
	...
	public $const_name = 'MAIN_MODULE_IMPRAP';

	/**
	 * @var string Module logo
	 * Should be named object_imprap.png and store under imprap/img
	 */
	public $picto = 'imprap@imprap';

	/** @var array Define module parts */
	public $module_parts = array(
		/** @var bool Module ships triggers in imprap/core/triggers */
		'triggers' => true,
		/**
		 * @var bool Module ships login in imprap/core/login
		 * @todo: example
		 */
		'login' => false,
		/**
		...
		'menus' => false,
		/**
		 * @var bool Module ships theme in imprap/theme
		 * @todo example
		 */
		'theme' => false,
		/**
		 * @var bool Module shipped templates in imprap/core/tpl overload core ones
		 * @todo example
		 */
		'tpl' => false,
		/**
	...
	public $config_page_url = 'setup.php@imprap';
	...
	public $langfiles = array('imprap@imprap');
	...
	public function __construct($db)
	{
		...
		//$this->tabs = array(
			...
			//	'objecttype:+tabname1:Title1:langfile@imprap:$user->rights->imprap->read:/imprap/mynewtab1.php?id=__ID__',
			//	// To add another new tab identified by code tabname2
			//	'objecttype:+tabname2:Title2:langfile@imprap:$user->rights->othermodule->read:/imprap/mynewtab2.php?id=__ID__',
		...
		// Dictionaries
		if (! isset($conf->imprap->enabled)) {
			$conf->imprap=new stdClass();
			$conf->imprap->enabled = 0;
		}
...
/* $this->menu[]=array(
		...
		// Menu's title. FIXME: use a translation key
			'titre'=>'ImpRap top menu',
		// This menu's mainmenu ID
			'mainmenu'=>'imprap',
		// This menu's leftmenu ID
			//'leftmenu'=>'imprap',
			'url'=>'/imprap/index.php',
		//	// Lang file to use (without .lang) by module.
		//	// File must be in langs/code_CODE/ directory.
			'langs'=>'mylangfile',
			'position'=>100,
		//	// Define condition to show or hide menu entry.
		//	// Use '$conf->imprap->enabled' if entry must be visible if module is enabled.
			'enabled'=>'$conf->imprap->enabled',
		//	// Use 'perms'=>'$user->rights->imprap->level1->level2'
		...
		//	'type'=>'left',
		// Menu's title. FIXME: use a translation key
		//	'titre'=>'ImpRap left menu',
		// This menu's mainmenu ID
		//	'mainmenu'=>'imprap',
		// This menu's leftmenu ID
		//	'leftmenu'=>'imprap',
		//	'url'=>'/imprap/pagelevel1.php',
		//	// Lang file to use (without .lang) by module.
		//	// File must be in langs/code_CODE/ directory.
		//	'langs'=>'mylangfile',
		//	'position'=>100,
	 ...
	 * and create data commands must be stored in directory /imprap/sql/
	...
	{
		return $this->_load_tables('/imprap/sql/');
	}
