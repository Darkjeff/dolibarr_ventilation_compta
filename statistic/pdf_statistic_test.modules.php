 ...
 *	\version    $Id: pdf_propale_azur.modules.php,v 1.199 2010/07/20 18:07:38 eldy Exp $
 */
	...
	function write_file($propale,$outputlangs, $date)
	{
		...
		if ($conf->propale->dir_output)
		{
			...
			if (file_exists($dir))
			{
				...
				if ($resql) // Si la requete a fonctioné
				{
				...
				for ($i = 0 ; $i < $numProducts ; $i++)
				{
					...
					//Requete mouvement date demandé
